...
/* -----------------------------------------------------------------------------
  ...
  the RFID attendance project with NodeMCU.
   ---------------------------------------------------------------------------*/
//************c:\Users\Himanshu\Downloads\RFID-Attendance-system-V2.0-master\RFID-Attendance-system-V2.0-master\NodeMCU_RFIDv2.0\NodeMCU_RFIDv2.0.ino*******************libraries********************************
//RFID-----------------------------
#include <SPI.h>
#include <MFRC522.h>
//NodeMCU--------------------------
...
const char* device_token  = "ac198db1465510f9";
//************************************************************************
